                                    ...
                                    if (llmPlanJson != null) {
                                        ...
                                        if (!plannedBlocks.isEmpty()
                                            ...
                                            if (padBounds == null) {
                                                ...
                                                final net.minecraft.block.BlockState finalFillMaterial = fillMaterial;
                                                    ...
                                                    for (int x = finalMinX; x <= finalMaxX; x++) {
                                                        for (int z = finalMinZ; z <= finalMaxZ; z++) {
                                                            for (int y = clearFromY; y <= clearToY; y++) {
                                                                ...
                                                                // 清理所有非空气方块（包括地形方块）
                                                                if (!current.isAir()) {
                                                                    out.add(new com.formacraft.server.build.PlannedBlock(clearPos, net.minecraft.block.Blocks.AIR.getDefaultState()));
                                                                }
                                                            }
                                                        }
                                                    }
