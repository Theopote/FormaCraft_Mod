...
public final class MassToStructuralDeriver {
    ...
    public static StructuralSkeleton deriveFromMassAssembly(MassAssembly massAssembly) {
        ...
        StructuralSkeleton.RoofPlate roofPlate = MassToRoofPlateDeriver.deriveRoofPlate(
                massAssembly,
                mainFloorPlate
        );
        ...
        List<StructuralSkeleton.AxisConstraint> axes = MassToAxisConstraintDeriver.deriveAxisConstraints(massAssembly);
