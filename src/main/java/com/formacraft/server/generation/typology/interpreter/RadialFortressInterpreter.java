...
import com.formacraft.server.generation.typology.builder.RadialFortressBuilder;
...
/** Native typology interpreter for {@code radial_fortress}. */
public final class RadialFortressInterpreter implements com.formacraft.common.typology.TypologyInterpreter {

    @Override
    public String typologyId() {
        return RadialFortressBuilder.TYPOLOGY_ID;
    }
    ...
    public List<BlockPatch> interpret(SemanticComponent semantic, ServerWorld world) {
        ...
        GeneratedStructure structure = RadialFortressBuilder.generate(params, origin, world, null);
