...
/** Native typology interpreter for {@code dense_eaves_pagoda} — no landmark id required. */
public final class DenseEavesPagodaInterpreter implements com.formacraft.common.typology.TypologyInterpreter {

    @Override
    public String typologyId() {
        return DenseEavesPagodaBuilder.TYPOLOGY_ID;
    }
    ...
    public List<BlockPatch> interpret(SemanticComponent semantic, ServerWorld world) {
        ...
        GeneratedStructure structure = DenseEavesPagodaBuilder.generate(params, origin, world, null);
