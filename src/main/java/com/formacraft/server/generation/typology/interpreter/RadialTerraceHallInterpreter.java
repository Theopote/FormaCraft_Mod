...
/** Native typology interpreter for {@code radial_terrace_hall} — no landmark id required. */
public final class RadialTerraceHallInterpreter implements com.formacraft.common.typology.TypologyInterpreter {

    @Override
    public String typologyId() {
        return RadialTerraceHallBuilder.TYPOLOGY_ID;
    }
    ...
    public List<BlockPatch> interpret(SemanticComponent semantic, ServerWorld world) {
        ...
        GeneratedStructure structure = RadialTerraceHallBuilder.generate(params, origin, world, null);
