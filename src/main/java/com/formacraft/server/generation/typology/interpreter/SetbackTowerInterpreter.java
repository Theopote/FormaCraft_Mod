...
import com.formacraft.server.generation.typology.builder.SetbackTowerBuilder;
...
/** Native typology interpreter for {@code setback_tower}. */
public final class SetbackTowerInterpreter implements com.formacraft.common.typology.TypologyInterpreter {

    @Override
    public String typologyId() {
        return SetbackTowerBuilder.TYPOLOGY_ID;
    }
    ...
    public List<BlockPatch> interpret(SemanticComponent semantic, ServerWorld world) {
        ...
        GeneratedStructure structure = SetbackTowerBuilder.generate(params, origin, world, null);
