...
import com.formacraft.server.generation.typology.builder.CourtyardCompoundBuilder;
...
/** Native typology interpreter for {@code courtyard_compound}. */
public final class CourtyardCompoundInterpreter implements com.formacraft.common.typology.TypologyInterpreter {

    @Override
    public String typologyId() {
        return CourtyardCompoundBuilder.TYPOLOGY_ID;
    }
    ...
    public List<BlockPatch> interpret(SemanticComponent semantic, ServerWorld world) {
        ...
        GeneratedStructure structure = CourtyardCompoundBuilder.generate(params, origin, world, null);
