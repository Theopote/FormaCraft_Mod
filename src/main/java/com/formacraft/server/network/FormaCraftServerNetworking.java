...
public final class FormaCraftServerNetworking {
    ...
    public static void sendPatchConfirm(UUID previewTicketId) {
        ...
        PatchConfirmPayload payload = new FormaCraftNetworking.PatchConfirmPayload(previewTicketId);
    ...
    public static void sendOutlineSync(OutlineShape outline) {
        MinecraftClient mc = MinecraftClient.getInstance();
        OutlineSyncPayload payload = new FormaCraftNetworking.OutlineSyncPayload(outline);
        if (mc != null && mc.getNetworkHandler() != null) {
            mc.getNetworkHandler().sendPacket(new CustomPayloadC2SPacket(payload));
            return;
        }
    ...
    public static void sendProtectedZoneSync(List<ProtectedZone> zones) {
        MinecraftClient mc = MinecraftClient.getInstance();
        ProtectedZoneSyncPayload payload = new FormaCraftNetworking.ProtectedZoneSyncPayload(zones != null ? zones : List.of());
        if (mc != null && mc.getNetworkHandler() != null) {
            mc.getNetworkHandler().sendPacket(new CustomPayloadC2SPacket(payload));
            return;
        }
    ...
    public static void sendPreviewAdjust(int dx, int dy, int dz) {
        MinecraftClient mc = MinecraftClient.getInstance();
        PreviewAdjustPayload payload = new FormaCraftNetworking.PreviewAdjustPayload(dx, dy, dz);
        if (mc != null && mc.getNetworkHandler() != null) {
            mc.getNetworkHandler().sendPacket(new CustomPayloadC2SPacket(payload));
            return;
        }
    ...
    public static void sendComponentCatalogRequest() {
        MinecraftClient mc = MinecraftClient.getInstance();
        ComponentCatalogRequestPayload payload = new FormaCraftNetworking.ComponentCatalogRequestPayload();
        if (mc != null && mc.getNetworkHandler() != null) {
            mc.getNetworkHandler().sendPacket(new CustomPayloadC2SPacket(payload));
            return;
        }
    ...
    public static void sendSaveComponent(String componentJson, byte[] thumbnailPng) {
        MinecraftClient mc = MinecraftClient.getInstance();
        ComponentSavePayload payload = new FormaCraftNetworking.ComponentSavePayload(componentJson, thumbnailPng);
        if (mc != null && mc.getNetworkHandler() != null) {
            mc.getNetworkHandler().sendPacket(new CustomPayloadC2SPacket(payload));
            return;
        }
    ...
    public static void sendComponentGetRequest(String componentId) {
        MinecraftClient mc = MinecraftClient.getInstance();
        ComponentGetRequestPayload payload = new FormaCraftNetworking.ComponentGetRequestPayload(componentId);
        if (mc != null && mc.getNetworkHandler() != null) {
            mc.getNetworkHandler().sendPacket(new CustomPayloadC2SPacket(payload));
            return;
        }
