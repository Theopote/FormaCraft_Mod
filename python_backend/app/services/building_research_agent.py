...
def synthesize_profile_with_llm(
    ...
    *,
    ...
    system = (
        ...
        "temple_of_heaven, birds_nest_stadium, golden_gate_bridge, gothic_cathedral, mingqing_courtyard, or castle_compound — they are typology-first only. "
...
def format_profile_for_prompt(profile: BuildingProfile) -> str:
    ...
    lines = [
        ...
        "temple_of_heaven, birds_nest_stadium, golden_gate_bridge, gothic_cathedral, mingqing_courtyard, castle_compound) NEVER use MODULE — even if Java LANDMARK MODULE blocks suggest it.",
